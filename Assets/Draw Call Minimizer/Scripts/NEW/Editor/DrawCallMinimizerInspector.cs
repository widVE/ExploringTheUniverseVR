...
namespace DCM {
    ...
    public class DrawCallMinimizerInspector : Editor {
		...
		private SerializedProperty makeChildOfOriginalObject;
		private SerializedProperty destroyInactiveSiblings;
        ...
        void OnEnable() {
			...
			makeChildOfOriginalObject = serializedObject.FindProperty("makeChildOfOriginalObject");
			destroyInactiveSiblings = serializedObject.FindProperty("destroyInactiveSiblings");
        ...
        public override void OnInspectorGUI() {
			...
			EditorGUILayout.PropertyField(makeChildOfOriginalObject);
			EditorGUILayout.PropertyField(destroyInactiveSiblings);
